package com.arqivame.user.infrastructure.messaging.consumer.rabbitmq;
...
import com.arqivame.user.infrastructure.messaging.consumer.MessageConsumer;
...
public abstract class RabbitMQMessageConsumer<T extends Serializable> extends MessageConsumer<Message<T>> {
    ...
    static class RabbitMQFailureHandler<T extends Serializable> implements MessageConsumer.FailureHandler<Message<T>> {
